...
/**
 * Only approved packages are shown to customers — a package generated
 * by the admin's margin-based tool (or added manually) stays hidden
 * from the customer site until an admin explicitly approves it in the
 * admin panel.
 */
